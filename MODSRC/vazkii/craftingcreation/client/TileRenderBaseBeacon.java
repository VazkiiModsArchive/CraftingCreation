...
public class TileRenderBaseBeacon extends TileEntitySpecialRenderer {

	public void renderBaseBeaconAt(TileEntityBaseBeacon par1TileEntityBeacon, double par2, double par4, double par6, float par8) {
		float f1 = 1F;
		Tessellator tessellator = Tessellator.instance;
        this.bindTextureByName("/mods/CraftingCreation/beam" + (par1TileEntityBeacon.isRedTeam() ? "Red" : "Blue") + ".png");
	...
	public void renderTileEntityAt(TileEntity tileentity, double d0, double d1, double d2, float f) {
		renderBaseBeaconAt((TileEntityBaseBeacon) tileentity, d0, d1, d2, f);
	}
