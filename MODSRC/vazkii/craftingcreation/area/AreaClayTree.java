...
public class AreaClayTree extends AreaGenerator {
	...
	public void generate(World world, int i, int k) {
		...
		world.setBlockAndMetadataWithNotify(i + 1, j + 1, k + 1, ModBlocks.creationClay.blockID, 0, 3);
		world.setBlockAndMetadataWithNotify(i + 1, j + 1, k + 5, ModBlocks.creationClay.blockID, 0, 3);
		world.setBlockAndMetadataWithNotify(i + 1, j + 3, k + 2, ModBlocks.creationClayBreakable.blockID, clayLevel, 3);
		...
		world.setBlockAndMetadataWithNotify(i + 2, j + 3, k + 1, ModBlocks.creationClayBreakable.blockID, clayLevel, 3);
		...
		world.setBlockAndMetadataWithNotify(i + 2, j + 5, k + 2, ModBlocks.creationClayBreakable.blockID, clayLevel, 3);
		...
		world.setBlockAndMetadataWithNotify(i + 3, j + 0, k + 3, ModBlocks.creationClayBreakable.blockID, clayLevel, 3);
		...
		world.setBlockAndMetadataWithNotify(i + 3, j + 3, k + 1, ModBlocks.creationClayBreakable.blockID, clayLevel, 3);
		...
		world.setBlockAndMetadataWithNotify(i + 3, j + 4, k + 2, ModBlocks.creationClayBreakable.blockID, clayLevel, 3);
		...
		world.setBlockAndMetadataWithNotify(i + 3, j + 5, k + 1, ModBlocks.creationClayBreakable.blockID, clayLevel, 3);
		world.setBlockAndMetadataWithNotify(i + 3, j + 5, k + 2, ModBlocks.creationClayBreakable.blockID, clayLevel, 3);
		...
		world.setBlockAndMetadataWithNotify(i + 3, j + 6, k + 2, ModBlocks.creationClayBreakable.blockID, clayLevel, 3);
		...
		world.setBlockAndMetadataWithNotify(i + 3, j + 7, k + 3, ModBlocks.creationClayBreakable.blockID, clayLevel, 3);
		...
		world.setBlockAndMetadataWithNotify(i + 4, j + 3, k + 1, ModBlocks.creationClayBreakable.blockID, clayLevel, 3);
		world.setBlockAndMetadataWithNotify(i + 4, j + 3, k + 2, ModBlocks.creationClayBreakable.blockID, clayLevel, 3);
		...
		world.setBlockAndMetadataWithNotify(i + 4, j + 3, k + 5, ModBlocks.creationClayBreakable.blockID, clayLevel, 3);
		world.setBlockAndMetadataWithNotify(i + 4, j + 4, k + 3, ModBlocks.creationClayBreakable.blockID, clayLevel, 3);
		world.setBlockAndMetadataWithNotify(i + 4, j + 5, k + 2, ModBlocks.creationClayBreakable.blockID, clayLevel, 3);
		...
		world.setBlockAndMetadataWithNotify(i + 4, j + 6, k + 3, ModBlocks.creationClayBreakable.blockID, clayLevel, 3);
		...
		world.setBlockAndMetadataWithNotify(i + 5, j + 1, k + 1, ModBlocks.creationClay.blockID, 0, 3);
		world.setBlockAndMetadataWithNotify(i + 5, j + 1, k + 5, ModBlocks.creationClay.blockID, 0, 3);
		world.setBlockAndMetadataWithNotify(i + 5, j + 3, k + 2, ModBlocks.creationClayBreakable.blockID, clayLevel, 3);
		world.setBlockAndMetadataWithNotify(i + 5, j + 3, k + 3, ModBlocks.creationClayBreakable.blockID, clayLevel, 3);
		world.setBlockAndMetadataWithNotify(i + 5, j + 3, k + 4, ModBlocks.creationClayBreakable.blockID, clayLevel, 3);
